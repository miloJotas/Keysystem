...
local Config = {
    ...
    ServiceId       = 26036, -- Your PlatoBoost Service ID
    PlatoSecret     = "3d28ddcb-98c4-4ab6-9ba0-33143a2733c2", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "1972", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/miloJotas/Keysystem/refs/heads/main/script.lua", -- The raw URL of your main script
    ...
    -- [6] GUI Management
    OldGuiName      = "robliux", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "robliux", -- Name of the main script's GUI to check if it's already executing

    -- [7] Hub Information & UI Text
    HubName         = "ROBLIUX 2.0", -- The main title shown at the top of the GUI
    HubDescription  = "Thanks you very much" -- The text shown below the title
}
